...
def main_loop_baseline_no_attention(args):
    print(args)
    ...
    for frame, next_frames, frame_number in videocapture.frame_generator_thread_loading():
        ...
        waited_for_attention_in_total = 0.0
        history.report_evaluation_attention_waiting(waited_for_attention_in_total, frame_number)
        ...
        active_coordinates = attentionmodel.get_active_crops_intersections([], evaluation_coordinates, frame)
